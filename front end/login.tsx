          ...
          <div className="p-8">
            <div className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-cyan-500 text-white py-3 rounded-lg font-semibold hover:from-blue-700 hover:to-cyan-600 transform hover:scale-[1.02] transition-all shadow-lg"
              >
                Đăng nhập
              </button>
            </div>
